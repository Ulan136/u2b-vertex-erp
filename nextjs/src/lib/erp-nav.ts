...
export const ERP_NAV: NavSection[] = [
  ...
  { title: 'Поверка', icon: '📋', zone: 'income', items: [
    ...
    { label: 'Районы', screenKey: 'poverka_districts', heading: true },
    { label: 'Сертификат', screenKey: 'poverka_districts', href: '/erp/certs?source=Районы&type=cert' },
    { label: 'Извещение', screenKey: 'poverka_districts', href: '/erp/certs?source=Районы&type=izv' },
  ...
  { title: 'Финансы', icon: '💳', zone: 'ops', items: [
    ...
    { label: 'Привязка счетов', screenKey: 'finance', href: '/erp/finance/accounts' },
  ] },
