...
const REF = [
  ...
  { icon: '🏢', title: 'Направления поверки', items: ['САМИ', 'ВДК', 'ТЭЦ', 'Выездная', 'Первичная (КМ/АК)', 'Астана', 'Районы'] },
  ...
  { icon: '📄', title: 'Разделы финансов', items: ['№1 Поверка', '№2 Продажа', '№3 Прочие операции', '№4 Филиал Астана', '№5 Филиал Алматы'] },
];
